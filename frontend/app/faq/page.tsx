    ...
    <main className="py-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto space-y-12">
      ...
      <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200/90 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          <Link
            href="/guides"
            className="px-4 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 !text-white hover:!text-white text-xs font-semibold shadow-2xs transition-colors flex items-center gap-1.5 group"
          >
            <span className="!text-white group-hover:!text-white">Read Guides</span>
            <ArrowRight className="w-3 h-3 !text-white group-hover:!text-white" />
          </Link>
        </div>
      </div>
    </main>
